...
# Module roots in longest-prefix order. Keep this list aligned with the
# independent Go modules in this repository.
MODULE_DIRS="ci_cd_sanity_tests providers/azure providers/aws providers/gcp pkg"
